...
function ListadoRutas() {
  ...
  const obtenerRutas = () => {
    axios.get("https://api-ucabrides-v2-7913fcd58355.herokuapp.com/api/rutas", {headers: {
  ...
  const obtenerOrdenes = () => {
    axios.get("https://api-ucabrides-v2-7913fcd58355.herokuapp.com/api/ordenes_rutas", {headers: {
      Authorization: `Bearer ${localStorage.getItem("access_token")}`
    }}).then((response) => {
      setOrdenes(response);
    });
  ...
  const obtenerVehiculos = async () => {
    const { data } = await axios.get("https://api-ucabrides-v2-7913fcd58355.herokuapp.com/api/vehiculos", {headers: {
      Authorization: `Bearer ${localStorage.getItem("access_token")}`
    }});
    setVehiculos(data);
  };
  ...
  const desactivarRuta = async (id) => {
    ...
    if (ordenes.data.users.length > 0 ) {
      enqueueSnackbar(
      ...
      iddeorden = ordenes.data._id || "";
      const r = await axios.post(`https://api-ucabrides-v2-7913fcd58355.herokuapp.com/api/desactivar`, {
  ...
  const sacar =async()=>{
    ...
    if(ordenes?.data.users.length > 0){
      ...
      const res=await axios.post('https://api-ucabrides-v2-7913fcd58355.herokuapp.com/api/eliminar_ruta',{ruta_id:ruta_eliminar._id}, {
        headers: {
        Authorization: `Bearer ${localStorage.getItem("access_token")}`
      }})
      if(res.error)
  ...
  React.useEffect(() => {
    ...
    axios.get("https://api-ucabrides-v2-7913fcd58355.herokuapp.com/api/contactosos", {
      headers: {
        Authorization: `Bearer ${localStorage.getItem("access_token")}`,
      },
    });
