...
const googleMapsApiKey = "AIzaSyD7v8N1XTXpHinGn0ka8CO0l61UWh1fesA";
...
function Map() {
  ...
  const handlecambiar = async () => {
    try {
      ...
      const res = await axios.post(`https://api-ucabrides-v2-7913fcd58355.herokuapp.com/api/cambiar_ubicacion`, {
  ...
  useEffect(() => {
    axios
      .get("https://api-ucabrides-v2-7913fcd58355.herokuapp.com/api/perfil_direccion", {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("access_token")}`
        }
      })
