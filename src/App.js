...
function App() {
  ...
  const orden_id = localStorage.getItem("ucabrides_orden_ruta_id");
    ...
    <>
      <Routes>
        ...
        >
          ...
          <Route path="/personalizar/ruta/:origenLat/:origenLng/:destinoLat/:destinoLng" element={<PersonalizarRuta />} />
